...
11. [Existing-system adopt/build/borrow comparison](research/comparisons/existing-systems.md)
12. [System requirements](requirements/system.md)
13. [First system-model design](designs/0001-system-model/README.md)
14. [State ownership and rollback design](designs/0002-state-ownership/README.md)
15. [Initial threat and trust model](designs/0003-threat-and-trust-model/README.md)
16. [Minimum viable authority and recovery model](designs/0004-authority-and-recovery/README.md)
17. [Fleet intent and configuration composition](designs/0005-fleet-intent-and-configuration/README.md)
18. [Storage layout, immutable root, and encryption](designs/0006-storage-layout-and-encryption/README.md)
19. [Package inputs and snapshot policy](designs/0007-package-inputs-and-snapshot-policy/README.md)
20. [Supply-chain evidence, reproducibility, and vulnerability assessment](designs/0008-supply-chain-evidence-and-vulnerability/README.md)
21. [Fleet release promotion and rollout control](designs/0009-fleet-release-rollout/README.md)
22. [Installation, provisioning, and machine enrollment](designs/0010-installation-and-enrollment/README.md)
23. [Secret custody and credential delivery](designs/0011-secret-and-credential-delivery/README.md)
24. [Unix identity and rootless-container ownership](designs/0012-unix-identity-and-rootless-containers/README.md)
25. [Software placement and execution boundaries](designs/0013-software-placement/README.md)
