...
| PRE-015 | Canonical fast and complete validation entry points define isolation, privileges, network/secrets, timeout, flaky, artifact, redaction, cleanup, and CI behavior. | Active | Accepted [validation execution contract](../project/validation-contract.md), [PR-0018](../project/reviews/0018-validation-contract.md), and [PR-0019](../project/reviews/0019-mise-validation-interface.md); four mise tasks, locked Linux-x64 Python 3.14/uv tooling, external XDG test cache, initial runner, named T0 checks, and registered hostile environment/cache/network/process probes implemented; full preflight result recording, canary scanning, retained empty-cache probe, clean local evidence, and passing initial CI job remain |
