...
| PRE-015 | Canonical fast and complete validation entry points define isolation, privileges, network/secrets, timeout, flaky, artifact, redaction, cleanup, and CI behavior. | Active | Accepted [validation execution contract](../project/validation-contract.md), [PR-0018](../project/reviews/0018-validation-contract.md), [PR-0019](../project/reviews/0019-mise-validation-interface.md), [PR-0020](../project/reviews/0020-validation-runner-hostile-probes.md), and [PR-0021](../project/reviews/0021-validation-failed-invocation-results.md); four mise tasks, locked Linux-x64 Python 3.14/uv tooling, external XDG test cache, result-producing failed invocations, named T0 checks, and registered hostile environment/cache/network/process probes implemented; canary scanning, retained empty-cache probe, clean local evidence, and passing initial CI job remain |
