...
The repository currently has no tracked root README, license, contributor or
agent instructions, `.gitignore`, `.editorconfig`, CI configuration, or
canonical test command. Before G1:
...
| PRE-012 | A concise agent context contract is documented, has explicit authority/update rules, and passes a clean-session comprehension exercise. | Active | [Current context](../project/current-context.md) drafted; [EX-0016](../research/exercises/0016-agent-context-and-instruction-loading.md) review and results pending |
| PRE-013 | Canonical tool-neutral repository instructions, minimal tool adapters, task isolation, concurrent-edit, commit, review, and handoff rules are defined and loading-tested. | Pending | Root `AGENTS.md`, thin Claude/Copilot adapters, and [EX-0016](../research/exercises/0016-agent-context-and-instruction-loading.md) results |
