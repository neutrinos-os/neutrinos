...
| PRE-015 | Canonical fast and complete validation entry points define isolation, privileges, network/secrets, timeout, flaky, artifact, redaction, cleanup, and CI behavior. | Active | Proposed [validation execution contract](../project/validation-contract.md), open [PR-0018](../project/reviews/0018-validation-contract.md), entry-point implementation, hostile probes, and passing initial CI job |
