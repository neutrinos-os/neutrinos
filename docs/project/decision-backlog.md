...
| S-004 | What are the disk, partition, filesystem, and encryption models? | [Storage ownership, integrity, encryption, recovery, and capacity requirements accepted; concrete layout and mechanism design remains in review](reviews/0009-storage-layout-and-encryption-requirements.md). Open sub-question sharpened by PLN-0001-04: SYS-049's authenticated root needs an exact UKI-to-root/Verity binding, and [DES-0006](../designs/0006-storage-layout-and-encryption/README.md) still asks whether EROFS or ext4+dm-verity is the substrate. Until that is answered SYS-049 cannot be demonstrated without selecting a mechanism by accident, which is why the owner deferred it to G2 rather than growing it in PLN-0001 | S-001, S-002 |
