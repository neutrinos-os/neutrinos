...
| R-003 | Signing-key loss or compromise makes machines unrecoverable or untrustworthy. | Critical | Review DES-0004; exercise authority loss through EX-0001, promotion substitution through EX-0002, and recovery abuse through EX-0003 before creating production keys. |
