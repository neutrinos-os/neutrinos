...
| R-015 | Exact machine variants and qualification create unsustainable build, storage, and test growth. | High | Measure workstation and router variants; maximize content reuse and compare per-machine rebuilds with separately bound immutable configuration artifacts. |
