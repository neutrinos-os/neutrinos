...
| --- | --- | --- | --- | --- | --- |
| Repository, agent, context, and test readiness ([PLN-0000](../plans/0000-pre-implementation-readiness.md)) | Accepted execution governance; not product architecture | Root `AGENTS.md`, hard-bounded current context, thin Claude/Copilot adapters; test entry point and repository conventions open | [EX-0016](../research/exercises/0016-agent-context-and-instruction-loading.md) passed Codex/Claude semantics, adversarial probes, freshness, discovery, and cold routing at `c96fdbb`; Copilot owner-deferred and unverified | Active | Blocking G1; PRE-012/PRE-013 satisfied; define PRE-014 test layers and trace, then validation entry points, repository baseline, and housekeeping |
