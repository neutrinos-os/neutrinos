...
| --- | --- | --- | --- | --- | --- |
| Repository, agent, context, and test readiness ([PLN-0000](../plans/0000-pre-implementation-readiness.md)) | Accepted execution governance; not product architecture | Canonical tool-neutral guidance with thin Codex/Claude/Copilot adapters leads; test entry point and repository conventions open | Current manual documentation checks pass; fresh-agent context, adapter-loading, test-strategy, CI, and hygiene evidence not defined | Active | Blocking G1; define and verify context, multi-agent workflow, test layers, repository baseline, and housekeeping before activating implementation |
