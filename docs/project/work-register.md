...
| --- | --- | --- | --- | --- | --- |
| Repository, agent, context, and test readiness ([PLN-0000](../plans/0000-pre-implementation-readiness.md)) | Accepted execution governance; not product architecture | Root `AGENTS.md` with thin Claude/Copilot adapters proposed; test entry point and repository conventions open | Current manual documentation checks pass; [EX-0016](../research/exercises/0016-agent-context-and-instruction-loading.md) proposed; client loading, test-strategy, CI, and hygiene evidence incomplete | Active | Blocking G1; review and run the context exercise, then define test layers, repository baseline, and housekeeping before activating implementation |
