...
| --- | --- | --- | --- | --- | --- |
| Repository, agent, context, and test readiness ([PLN-0000](../plans/0000-pre-implementation-readiness.md)) | Accepted execution governance, [test and evidence strategy](test-strategy.md), and [validation execution contract](validation-contract.md); not product architecture | Root `AGENTS.md`, hard-bounded current context, thin Claude/Copilot adapters; test taxonomy and `./check` execution/evidence/CI contract accepted; entry-point implementation and repository conventions open | [EX-0016](../research/exercises/0016-agent-context-and-instruction-loading.md) passed Codex/Claude semantics, adversarial probes, freshness, discovery, and cold routing at `c96fdbb`; PR-0017/PR-0018 accepted; Copilot owner-deferred and unverified | Active | Blocking G1; implement and hostile-probe `./check`, pass clean local and initial CI profiles, then define repository baseline and housekeeping |
