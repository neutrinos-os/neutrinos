...
Research documents collect evidence used by designs. They should separate
...
- [maintaining the record corpus: approvals, artifact lifecycle, and a derived graph](comparisons/record-corpus-maintenance.md)
